...
function ProjectVendor({ value, onChange, isEditable, onRequestEdit, saving }) {
    ...
    return <div className="mt-4 space-y-2">
        <label className="block text-xs font-semibold text-stone-600">Project vendor
            {isEditable ? <select disabled={saving || loading || Boolean(error)} value={value || ''} onChange={e => onChange(e.target.value || null)} className="mt-1 block w-full rounded-lg border crm-surface bg-white p-2 text-sm sm:max-w-sm">
